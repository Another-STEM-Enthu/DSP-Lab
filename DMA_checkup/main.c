...
void main(void) 
{
	...
	while (1)
	{
        ...
        {
			for (i = 0; i < PING_PONG_SIZE/2; i++) 			//If this condition is satisfied, then output PING buffer is filled. Access it. 
			{												//output PING buffer is essentially the last half of DMA_OutX.

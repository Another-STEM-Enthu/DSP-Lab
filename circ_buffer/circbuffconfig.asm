...
;***** Your AR1 configuration code goes here *****
	 ...
	 BSET AR1LC
	 ;Circular buffer size is 3 words
	 ;AR1 is configured to be modified circularly
	 AMOV #000000h, XAR1 ;Circular buffer is in main data page 01
	 MOV #1900h, BSA01 ;Circular buffer start address is 010A02h
	 MOV #0000h, AR1

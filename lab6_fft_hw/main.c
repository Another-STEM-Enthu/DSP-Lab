...
Int16 x[FFT_LENGTH]={1,1,2,2,3,3,4,4};
...
//	 	mag[i]=(realpart_fft[i]*realpart_fft[i]+imagpart_fft[i]*imagpart_fft[i]);
		mag[i] = (_lsmpy(realpart_fft[i], realpart_fft[i]) + _lsmpy(imagpart_fft[i], imagpart_fft[i]))>>1;
	 }

...
_label: MAC *AR5+,*AR4+,AC0
   ;MPY *AR5+,*AR4+, AC1			    ; AC1= (value at Address(AR5) x value at Address(AR4)) 
                    					; Also, address at AR5 and AR4 increments by one (points to the next memory location of size word, i.e, 16 bits)
   ;_label:	ADD AC1, AC0					; Accumulate the product in accumulator AC0
											
	MOV AC0,*AR7					; Move the higher byte of the result to the output pointer, here AR7 is containing the output address

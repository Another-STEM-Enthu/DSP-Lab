...
Int16 *numCoeff;    //pointer to the coefficients
Int16 *denCoeff;    //pointer to the coefficients
Int16 input;
Int16 output;
...
Int16 den_coeff[ORDER_IIR-1]={50,40};
...
int main( void )
{
	...
	numCoeff = &num_coeff[0]; 
	denCoeff = &den_coeff[0]; 	
	inPtr = &input;	 
	outPtr = &output;
...
//    {
//		while((Rcv & I2S0_IR) == 0);
//    	/*If you are not able to obtain output waveform on DSO then divide the I2S0_W0_MSW_R 
//    	 and I2S0_W1_MSW_R by 100 in both of the below two lines. Observe the peak to peak values of 
//    	 recent_output[] array in Graph Window. 
//    	 Then apply appropriate scaling to the output variable before sending the data over the 
//    	 CODEC (in the two statements below the second while loop)*/
//    	// Follow the similar procedure as done in main.c file
//    	input = I2S0_W0_MSW_R;
//		input = I2S0_W1_MSW_R;
//		
//        directform1();
//    		
//        recent_output[j]=100*output;
//        recent_input[j]=input;
//    		
//    	while((XmitR & I2S0_IR) == 0);
//    	I2S0_W0_MSW_W = 100*output;
//      	I2S0_W1_MSW_W = 100*output;
//    		
//		j=(j+1)%100;
//    }	
